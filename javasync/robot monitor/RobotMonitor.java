...
public class RobotMonitor 
{
    ...
    // fix these later to use lock
    public boolean isHumanInDanger() { return flagHumanInDanger ; }
    public boolean hasOrderFromHuman() { return flagOrderFromHuman ; }
    public boolean isSelfInDanger() { return flagSelfInDanger ; }
