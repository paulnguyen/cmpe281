 ...
 */
public class SMImplVersion5 implements SM {
  ...
  private Volume btree_index_volume = null ;    // volume id = 3
  ...
  public SMImplVersion5() {
    ...
    btree_index_volume = new Volume(3,"bindex.db",10,50);
