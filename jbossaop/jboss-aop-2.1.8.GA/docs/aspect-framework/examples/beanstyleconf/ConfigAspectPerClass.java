 ...
 */
public class ConfigAspectPerClass
{
   String[] attr1;
   Advisor advisor;
   ...
   public Object methodAdvice(Invocation invocation) throws Throwable
   {
      try
      {      
	      System.out.println("<<< Enter ConfigAspectPerClass");
      ...
      {
	      System.out.println(">>> Leave ConfigAspectPerClass");         
      }
   }
