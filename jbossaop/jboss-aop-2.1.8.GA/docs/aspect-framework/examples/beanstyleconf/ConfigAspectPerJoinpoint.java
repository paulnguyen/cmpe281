 ...
 */
public class ConfigAspectPerJoinpoint
{
   String[] attr1;
   Advisor advisor;
   ...
   public ConfigAspectPerJoinpoint()
   {
   }
   ...
   public Object methodAdvice(Invocation invocation) throws Throwable
   {
      try
      {
         System.out.println("<<< Enter ConfigAspectPerJoinpoint");
      ...
      {
         System.out.println(">>> Leave ConfigAspectPerJoinpoint");
      }
   }
