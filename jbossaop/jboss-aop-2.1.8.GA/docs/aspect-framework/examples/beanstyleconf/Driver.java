...
public class Driver
{
   public static void main(String[] args)
   {
      ...
      pojo.interceptorMethod();
      System.out.println("--- pojo.aspectPerVmMethod(); ---");
      pojo.aspectPerVmMethod();
      System.out.println("--- pojo.aspectPerClassMethod(); ---");
      pojo.aspectPerClassMethod();
      System.out.println("--- pojo.aspectPerInstanceMethod(); ---");
      pojo.aspectPerInstanceMethod();
      System.out.println("--- pojo.aspectPerJoinpointMethod(); ---");
      pojo.aspectPerJoinpointMethod();
