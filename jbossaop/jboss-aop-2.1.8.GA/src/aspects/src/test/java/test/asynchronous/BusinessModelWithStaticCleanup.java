...
public class BusinessModelWithStaticCleanup extends BusinessModel
 {
	public BusinessModelWithStaticCleanup() {}
	public BusinessModelWithStaticCleanup(long sleepTime) {
		super(sleepTime);
	}
