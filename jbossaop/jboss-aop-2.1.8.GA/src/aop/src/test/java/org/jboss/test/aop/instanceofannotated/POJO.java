...
public class POJO extends AnnotatedSuperClass implements AnnotatedInterface
{
   ...
   public POJO(Type typedef, Type instof, int i)
   {
   ...
   public Type paramsAndInstanceofReturn(Type typedef, Type instof, int i)
   {
      System.out.println("paramsAndInstanceofReturn()");
      return new Type(4);
   }
 
   public Type paramsAndTypedefReturn(Type typedef, Type instof, int i)
   {
