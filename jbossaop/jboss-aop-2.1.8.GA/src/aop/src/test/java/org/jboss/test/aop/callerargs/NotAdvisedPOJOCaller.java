 ...
 * @version $Revision$
 */
public class NotAdvisedPOJOCaller
{
   public NotAdvisedPOJOCaller()
   {
      CallerInterceptor.intercepted = false;
      NotAdvisedPOJO.voidStaticNoArgsMethod();
      ...
      CallerInterceptor.intercepted = false;
      NotAdvisedPOJO pojo = new NotAdvisedPOJO();
      if (!CallerInterceptor.intercepted) throw new RuntimeException("Did not intercept");
      if (CallerInterceptor.argsLength != 0) throw new RuntimeException("Args length should have been 0");
      ...
      if (((Integer)CallerInterceptor.args[1]).intValue() != 100) throw new RuntimeException("Args[1] should have been 100");
