 ...
 * was configured to have only the constructor joinpont prepared.
...
public class HotSwapDisabledTester extends AOPTestWithSetup
{
   ...
   /**
    * Asserts only pojo constructor joinpoint is wrapped.
    * @param wrappingInfos contains the joinpoints wrapping informations to be checked.
    */
   private void assertOnlyConstructorWrapped(POJOWrappingInfo[] wrappingInfos) throws Exception
   {
