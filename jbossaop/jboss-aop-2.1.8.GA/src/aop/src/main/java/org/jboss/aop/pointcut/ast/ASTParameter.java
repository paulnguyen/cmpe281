...
public class ASTParameter extends SimpleNode
{
   ...
   public ASTParameter(PointcutExpressionParser p, int id)
   {
      super(p, id);
   }
   ...
   boolean anyZeroOrMoreParameters;
   ...
   public boolean isAnyZeroOrMoreParameters()
   {
      return anyZeroOrMoreParameters;
   }

   public String toString() { return typeExpression; }
}
