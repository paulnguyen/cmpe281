 ...
 *
 **/
public class ConstructorCalledByConstructorInvocationWrapper extends ConstructorCalledByConstructorInvocation
{
   private static final long serialVersionUID = -3045541205784967429L;
   ...
   {
      ConstructorCalledByConstructorInvocationWrapper invocation = new ConstructorCalledByConstructorInvocationWrapper((ConstructorCalledByConstructorInvocation)wrapped.copy(), interceptors);
