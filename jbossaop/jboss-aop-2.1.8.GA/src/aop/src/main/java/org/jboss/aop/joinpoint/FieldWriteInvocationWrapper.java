...
{
   static final long serialVersionUID = -5435217977419419783L;
   ...
   {
      FieldWriteInvocationWrapper invocation = new FieldWriteInvocationWrapper((FieldWriteInvocation)wrapped.copy(), interceptors);
