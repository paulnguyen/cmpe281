...
class ApiClientController {
	...
	def index() {
		...
		def http = new HTTPBuilder("http://localhost:8080/GrailsWebServicesVer1/api")
		String output = "<hr/>"		
	...
	def putTest() {
		...
		def http = new HTTPBuilder("http://localhost:8080/GrailsWebServicesVer1/api/PPPL123456789")
		String output = "<hr/>"
